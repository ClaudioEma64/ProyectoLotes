...
# Numero para modeficar la deteccion de lineas de la imagen
...
#main
def main():
    global deteccion_linea, img ,img_lineas, img_temp, gray, factor_zoom

    tranformadaHough(deteccion_linea)
    #creo ventana con nombre image
    cv2.namedWindow('Lotes')
    cv2.namedWindow('Imagen Original')
# pongo la imagen para tener una referencia de que Area estoy marcando
    
    cv2.imshow("Imagen Original", img.copy())

    #cv2.setMouseCallback('Lotes', dibujar_Area_Lote)

    print("Instrucciones:")
    print("1. Seleccione un area que desea dibujar con el mouse")
    print("2. Correcion de Deteccion de linea 'k' Dismininuye cantidad de lineas  ")
    print("3. Correcion de Deteccion de linea 'p' Aumenta cantidad de lineas ")
    print("4. Presione 'q' para salir")
    print("5. Presione 'a' para Mas ZOOM")
    print("6. Presione 'd' para MEnos ZOOM")
    ...
    while(1):
#        cv2.imshow("Imagen Original", img_temp)
